...
if __name__ == '__main__':
    ...
    class CFG:
        ...
        ckpt_name = "resnext101_32x8d_img224224_bs128_fold4_2.5d_shift1" # eg: "efficientnetb1_img224224_bs128_fold4_2.5d_shift1"
    ...
    if test_flag:
        ...
        for i in range(CFG.pl_epoch):
            ...
            ##### 步骤一：不断利用（train_testPL）微调的权重 => 推理并生成新的df => 生成新的testPL
            ...
            ##### 步骤二：train + testPL 生成新的dataframe.
            ...
            for fold in range(CFG.n_fold):
                ...
                ##### 步骤三：加载前一步（train_testPL）训练好的weight. 如果刚开始，加载的本地训练好的weight
